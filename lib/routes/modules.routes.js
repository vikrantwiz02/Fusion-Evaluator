...
router.put('/modules/:id/specifications/zip', wrap(modulesCtrl.updateSpecificationsZip));
router.get('/modules/:id/team-specifications', wrap(modulesCtrl.getTeamsSpecifications));
router.put('/modules/:id/team-specifications', wrap(modulesCtrl.updateTeamsSpecifications));
router.put('/modules/:id/team-specifications/zip', wrap(modulesCtrl.updateTeamsSpecificationsZip));
