...
function normalizeSpecLayout(layout) {
  ...
  return {
    ...
    extraSections: normalizeExtraSections(layout.extraSections),
  };
}
...
export async function updateModuleSpecifications(id, payload, actor) {
  ...
  const updated = await prisma.module.update({
    ...
    data: {
      ...
      spec_layout: normalizeSpecLayout(payload.layout),
    },
  });
  ...
  return {
    ...
    layout: updated.spec_layout && typeof updated.spec_layout === 'object' && !Array.isArray(updated.spec_layout)
      ? updated.spec_layout
      : { columnWidths: {}, rowHeights: {}, extraSections: [] },
  };
}
