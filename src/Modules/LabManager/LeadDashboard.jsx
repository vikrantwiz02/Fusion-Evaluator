              ...
              <div className={`grid grid-cols-1 ${moduleData.has_backend && moduleData.has_frontend ? 'xl:grid-cols-2' : ''} gap-6`}>
                ...
                {moduleData.has_frontend && (
                  <div className="space-y-6 bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                    ...
                    <EditableList title="Components List" items={selectedGroup.evaluation.frontend?.components || []} onUpdate={items => updateGroupSection(selectedGroup, 'frontend', 'components', items)} icon={Layout} />
